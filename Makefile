...
SRC = main.c ./src/parsing/parsing_start.c  \
	...
	./src/validation/validation_map.c ./src/validation/validation_walls.c ./src/parsing/parse_map.c\
	./src/parsing/verif_elements.c ./src/parsing/verif_file.c ./src/parsing/parse_textures.c \
