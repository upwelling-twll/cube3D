...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/02/17 18:59:06 by ssiddiqu          #+#    #+#             */
/*   Updated: 2025/02/17 18:59:06 by ssiddiqu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
float	set_ray(t_game_data *data, float v)
{
	...
	while (1)
	{
		...
		{
			if (iswall(data->maplines[(int)new_ray.horiz.y
						+ (new_ray.sy - 1) / 2][(int)new_ray.horiz.x]))
